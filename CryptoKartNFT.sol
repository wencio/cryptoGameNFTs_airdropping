...
/// @param id number of the NFT
/// @return uri of the given NFT 
...
/// @param ( Integer Id of the NFT to set, string corresponding of the uri )
/// @return Update the mapping of NFT with corresponding uri
...
/// @return Unpause the contract
    ...
    /// @param (address account to assign the NFT, Integer identifier of the NFT, integer quantity of the NFT to be minted, bytes data)
    /// @return minted NFT
    ...
    /// @param (address account to assign the NFT, Integer identifiers of the NFTs, integers amounts of the NFTs to be minted, bytes datas)
    /// @return batch minted NFTs 
